...
def make_available():
    ...
    app_data = {
        ...
        'app_logo': getenv('LOGO_URL', "static/showcase/img/brand/favicon.svg"),
        'site_logo': getenv('LOGO_URL', "static/showcase/img/brand/favicon.svg"),
        'site_link': 'https://www.techa.salesnet.ng',
        'whatsapp_link': 'https://www.techa.salesnet.ng',
        'terms_link': 'https://www.techa.salesnet.ng/terms',
        'policy_link': 'https://www.techa.salesnet.ng/policy',
        'cookie_link': 'https://www.techa.salesnet.ng/cookie',
